...
- <code title="put /v1/user/hubs/{project_id}/pin">client.user.hubs.<a href="./src/morta/resources/user/hubs.py">toggle_pin</a>(project_id) -> <a href="./src/morta/types/user/hub_toggle_pin_response.py">HubTogglePinResponse</a></code>
...
- <code title="post /v1/hub/{hub_id}/set-column-format/{kind}">client.hub.<a href="./src/morta/resources/hub/hub.py">set_column_format</a>(path_kind, \*, hub_id, \*\*<a href="src/morta/types/hub_set_column_format_params.py">params</a>) -> None</code>
