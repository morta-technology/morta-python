...
__all__ = ["ColumnAddParams", "AlterOptions", "Description"]


class ColumnAddParams(TypedDict, total=False):
    locked: Required[bool]

    required: Required[bool]

    sort_order: Required[Annotated[int, PropertyInfo(alias="sortOrder")]]
