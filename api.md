...
- <code title="get /v1/table/{table_id}/csv-backup">client.table.<a href="./src/morta/resources/table/table.py">get_csv_backup</a>(table_id, \*\*<a href="src/morta/types/table_get_csv_backup_params.py">params</a>) -> BinaryAPIResponse</code>
